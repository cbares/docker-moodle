...
$string['combinedforms'] = 'Combined forms (questions + answer form)';
$string['combinedformforgroup'] = 'Question and answer form for group {$a}';
$string['combinedformall'] = 'Question and answer forms for all groups (single file)';
...
$string['fileprefixcombined'] = 'combined_form';
$string['fileprefixcombinedall'] = 'combined_form_all';
